...
static const char *fonts[]               = { "JetBrainsMono Nerd Font Mono:style=medium:size=13", "WenQuanYi Micro Hei Mono:style=Regular:size=12", "Noto Color Emoji:style=Regular", "monospace:size=13" };
